...
``` bash
wget 'https://raw.githubusercontent.com/mulle-cc/mulle-clang-project/refs/heads/mulle/21.1.8/clang/bin/install-prerequisites'
...
``` bash
VERSION=21.1.8.5 RC= ./create-deb "bullseye"
```
...
``` bash
VERSION=21.1.8.5 package-build
```
